...
# Cette modification ajoute une nouvelle route /batch_predict qui accepte une liste d'images téléchargées via une requête POST. 
# Les images sont lues à partir de la demande sous forme de fichiers, transformées et prédites individuellement, 
# puis les prédictions sont renvoyées sous forme de liste JSON. 
