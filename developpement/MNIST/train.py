...
if __name__=='__main__':
  ...
  torch.save(net.state_dict(), 'weights/mnist_net.pth') # dictionnaire Python contenant tous les poids et biais du réseau.
  #net.load_state_dict(torch.load('weights/mnist_net.pth'))
